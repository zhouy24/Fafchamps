---
title: "Undirectional relationship"
...
generate matrix age_1 that has n rows with each row repeats the same age age_2 that has n columns

with each column repeats the same age generate matrix gender_1 that has n rows with each row

repeats the same gender gender_2 that has n columns with each column repeats the same gender
...
plot and compare confidence intervals that computed in two different ways
