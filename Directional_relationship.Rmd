...
graph.  Confidence intervals on the left are generated using the method presents in the paper which

is really small as some small dots in the graph and most of them do not cover the true value of

beta1.  Confidence intervals on the right are generated using the standard variance which is
